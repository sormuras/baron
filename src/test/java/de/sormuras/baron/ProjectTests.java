...
class ProjectTests {
  ...
  void creatingGroupWithSameNameFails() {
    Exception e =
        assertThrows(
            ...
            () -> Project.builder().groupBuilder("name").buildGroup().groupBuilder("name"));
    assertEquals("name already defined", e.getMessage());
  }

  @Test
  void defaults() {
    var project = Project.builder().buildProject();
  ...
  void demoJigsawQuickStartGreetingsWorld() {
    ...
    var root = Path.of("demo", "jigsaw-quick-start", "greetings-world");
    var actual = Project.of(root, Path.of("src"));
  ...
  void demoJigsawQuickStartGreetingsWorldWithMainAndTest() {
    ...
    var root = Path.of("demo", "jigsaw-quick-start", "greetings-world-with-main-and-test");
    var actual = Project.of(root, Path.of("src", "main"), Path.of("src", "test"));
